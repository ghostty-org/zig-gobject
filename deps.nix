...
linkFarm name [
  {
    name = "gobject_codegen-0.3.2-B33qzUZkBwClXYYiisnB18xbuUvR8B2Z9C28-bnLxbnA";
    path = fetchZigArtifact {
      name = "gobject_codegen";
      url = "git+https://github.com/jcollie/zig-gobject#4ff7b4d030465b50796b90af72fec41eb9b3b5c6";
      hash = "sha256-911fSYz2Bb2yDGfmOfXJ16UUI+EtRB7NfpYPIakuPLs=";
      unpack = true;
    };
  }
  {
